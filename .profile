...
alias proxy='java -jar GunbotProxyCommunity-0.9.7.jar'
alias stats='sudo unshare -m bash -c "mount ~/gunbot/my_hosts /etc/hosts --bind; bash"'
alias cls='clear'
alias crash='source ~/.profile' && echo Shortcuts reloaded!
alias gcd='cd ~/gunbot/'
alias ana='cd ~/.anapolo'
alias pairs='python ~/gunbot/zeng.py'
alias fees='cd ~/.anapolo && python3 poloniex.py -a CalculateFees && gcd'
alias getBTC='cd ~/.anapolo && python3 poloniex.py -a GetChangeOverTime && gcd'
alias getETH='cd ~/.anapolo && python3 poloniex.py -a GetETHOverTime && gcd'
alias getXMR='cd ~/.anapolo && python3 poloniex.py -a GetXMROverTime && gcd'
alias getUSDT='cd ~/.anapolo && python3 poloniex.py -a GetUSDTOverTime && gcd'
alias overview='cd ~/.anapolo && python3 poloniex.py -a GetOverview && gcd'
alias profits='cd ~/.anapolo && python3 poloniex.py -a GetDetailedOverview && gcd'
alias gunbot='gcd && tmux attach -t gunbot'
alias trades='gcd && python ~/gunbot/trades.py'
alias btrades='gcd && python ~/gunbot/btrades.py'
alias monitor='gmon -cs -p ~/gunbot/ --show-all-errors --hide-inactive 24 -d 4'
alias pmonitor='gmon -cs -p ~/gunbot/ -m poloniex --show-all-errors --hide-inactive 24 -d 4'
alias bmonitor='gmon -cs -p ~/gunbot/ -m bittrex --show-all-errors --hide-inactive 24 -d 4'
alias upmonitor='npm install -g gunbot-monitor && cls'

function getBTC () {
    nohup getBTC "$@" > /dev/null 2>&1 & disown
}

function getETH () {
    nohup getETH "$@" > /dev/null 2>&1 & disown
}

function getXMR () {
    nohup getXMR "$@" > /dev/null 2>&1 & disown
}

function getUSDT () {
    nohup getUSDT "$@" > /dev/null 2>&1 & disown
}
...
function bmonitor () {
    nohup bmonitor "$@" > /dev/null 2>&1 & disown
}

function pmonitor () {
    nohup pmonitor "$@" > /dev/null 2>&1 & disown
}

function upmonitor () {
    nohup upmonitor "$@" > /dev/null 2>&1 & disown
}
...
alias bit_MYST='./gunthy-linuxx64 BTC_MYST bittrex'
...
alias bit_NMR='./gunthy-linuxx64 BTC_NMR bittrex'
...
alias bit_SC='./gunthy-linuxx64 BTC_SC bittrex'
...
alias bit_SNT='./gunthy-linuxx64 BTC_SNT bittrex'
...
# TREX ETH
alias bit_ETH_1ST='./gunthy-linuxx64 ETH_1ST bittrex'
alias bit_ETH_ADT='./gunthy-linuxx64 ETH_ADT bittrex'
alias bit_ETH_ADX='./gunthy-linuxx64 ETH_ADX bittrex'
alias bit_ETH_ANT='./gunthy-linuxx64 ETH_ANT bittrex'
alias bit_ETH_BAT='./gunthy-linuxx64 ETH_BAT bittrex'
alias bit_ETH_BNT='./gunthy-linuxx64 ETH_BNT bittrex'
alias bit_ETH_CFI='./gunthy-linuxx64 ETH_CFI bittrex'
alias bit_ETH_CRB='./gunthy-linuxx64 ETH_CRB bittrex'
alias bit_ETH_CVC='./gunthy-linuxx64 ETH_CVC bittrex'
alias bit_ETH_DASH='./gunthy-linuxx64 ETH_DASH bittrex'
alias bit_ETH_DGD='./gunthy-linuxx64 ETH_DGD bittrex'
alias bit_ETH_ETC='./gunthy-linuxx64 ETH_ETC bittrex'
alias bit_ETH_FUN='./gunthy-linuxx64 ETH_FUN bittrex'
alias bit_ETH_GNO='./gunthy-linuxx64 ETH_GNO bittrex'
alias bit_ETH_GNT='./gunthy-linuxx64 ETH_GNT bittrex'
alias bit_ETH_GUP='./gunthy-linuxx64 ETH_GUP bittrex'
alias bit_ETH_HMQ='./gunthy-linuxx64 ETH_HMQ bittrex'
alias bit_ETH_LGD='./gunthy-linuxx64 ETH_LGD bittrex'
alias bit_ETH_LTC='./gunthy-linuxx64 ETH_LTC bittrex'
alias bit_ETH_LUN='./gunthy-linuxx64 ETH_LUN bittrex'
alias bit_ETH_MCO='./gunthy-linuxx64 ETH_MCO bittrex'
alias bit_ETH_MTL='./gunthy-linuxx64 ETH_MTL bittrex'
alias bit_ETH_MYST='./gunthy-linuxx64 ETH_MYST bittrex'
alias bit_ETH_NMR='./gunthy-linuxx64 ETH_NMR bittrex'
alias bit_ETH_OMG='./gunthy-linuxx64 ETH_OMG bittrex'
alias bit_ETH_PAY='./gunthy-linuxx64 ETH_PAY bittrex'
alias bit_ETH_PTOY='./gunthy-linuxx64 ETH_PTOY bittrex'
alias bit_ETH_QRL='./gunthy-linuxx64 ETH_QRL bittrex'
alias bit_ETH_REP='./gunthy-linuxx64 ETH_REP bittrex'
alias bit_ETH_RLC='./gunthy-linuxx64 ETH_RLC bittrex'
alias bit_ETH_SC='./gunthy-linuxx64 ETH_SC bittrex'
alias bit_ETH_SNGLS='./gunthy-linuxx64 ETH_SNGLS bittrex'
alias bit_ETH_SNT='./gunthy-linuxx64 ETH_SNT bittrex'
alias bit_ETH_STORJ='./gunthy-linuxx64 ETH_STORJ bittrex'
alias bit_ETH_TIME='./gunthy-linuxx64 ETH_TIME bittrex'
alias bit_ETH_TKN='./gunthy-linuxx64 ETH_TKN bittrex'
alias bit_ETH_TRST='./gunthy-linuxx64 ETH_TRST bittrex'
alias bit_ETH_WINGS='./gunthy-linuxx64 ETH_WINGS bittrex'
alias bit_ETH_XRP='./gunthy-linuxx64 ETH_XRP bittrex'
alias bit_ETH_ZEC='./gunthy-linuxx64 ETH_ZEC bittrex'
